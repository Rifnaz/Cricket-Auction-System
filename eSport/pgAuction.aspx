        ...
        <div class="row">
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="col" style="text-align:left;">
                    ...
                    <asp:Label style="color:white; font-size:22px; margin-left:18px" ID="lb_currentTeam" runat="server" Text="CSK"></asp:Label>
                    <asp:Label style="color:white; font-size:22px; margin-left:18px" ID="lb_currentPrice" runat="server" Text="40000"></asp:Label>
            ...
            <div class="priceDiv">
                    ...
                    <asp:DropDownList ID="DropDownList1" class="priceInput" runat="server"></asp:DropDownList>
                    <asp:Button ID="btnSetPrice"  class="btn btn-warning" runat="server" Text="UPDATE" />
                    <asp:Button ID="btnDecline"  class="btn btn-success" runat="server" Text="SOLD" />
                    <asp:Button ID="Button1"  class="btn btn-danger" runat="server" Text="UNSOLD" />
